...
2) **Retrieval**：structured filter、BM25(FTS5)、Dense(Chroma)、RRF 融合、Evidence Pack 组装
...
- Retrieval：structured filter + FTS5(BM25) + Chroma(dense) + RRF；Evidence Pack 冻结与引用回放

...
| Cross-encoder reranker | `drift` | 代码里实现的是 OpenAI-compatible chat scorer / deterministic mock scorer，不是真实 cross-encoder model。功能可用，但与 spec 名义能力不一致，不能按“真实 cross-encoder”记 `done`。 | [server/app/retrieval/reranker.py](/Users/lee/Documents/AI/Document%20Assistant%20Agent/server/app/retrieval/reranker.py#L200) |
...
| Literary pipeline `top-1 raw_excerpt + top-2/3 safe_summary anchors` | `drift` | spec/plan 要求 raw_excerpt + safe_summary 的 anchor prompt；当前实现只生成 3 个 citation anchors 和模板化文本，没有 raw_excerpt、没有 top-1/top-2/3 区分、没有真实 prompt 组装。 | [IMPLEMENTATION_PLAN.md](/Users/lee/Documents/AI/Document%20Assistant%20Agent/IMPLEMENTATION_PLAN.md#L165), [DEV_SPEC.md](/Users/lee/Documents/AI/Document%20Assistant%20Agent/DEV_SPEC.md#L1690), [server/app/agents/literary/service.py](/Users/lee/Documents/AI/Document%20Assistant%20Agent/server/app/agents/literary/service.py#L8) |

    ...
    def train_policy(
        ...
        artifact_payload = {
            ...
            "training_config": {
                ...
                "validation_split": resolved_request.validation_split,
                "eval_steps": resolved_request.eval_steps,
                "early_stopping_patience": resolved_request.early_stopping_patience,
                "early_stopping_threshold": resolved_request.early_stopping_threshold,
